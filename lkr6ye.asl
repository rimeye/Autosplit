...
{
	byte myhp          : "fceux.exe", 0x3C920C, 0x3E5;
	byte bosshp        : "fceux.exe", 0x3C920C, 0x3ED;
	byte stage         : "fceux.exe", 0x3C920C, 0x51;
	byte currentscreen : "fceux.exe", 0x3C920C, 0x92;
	byte mymenuselection : "fceux.exe", 0x3C920C, 0x5B1;
