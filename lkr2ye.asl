...
{
	byte bosshp       : "fceux.exe", 0x3C920C, 0x6C1;
	byte myhp         : "fceux.exe", 0x3C920C, 0x6C0;
	byte mylives      : "fceux.exe", 0x3C920C, 0xA8;
	byte mytitlescreen: "fceux.exe", 0x3C920C, 0x04B0;
	byte mycontroller : "fceux.exe", 0x3C920C, 0x25;
	byte soundfx      : "fceux.exe", 0x3C920C, 0xE2;
	byte stage        : "fceux.exe", 0x3C920C, 0x2A;
}

// fceux-2.6.6-y320-Win32-汉化特供版
state("fceux", "2.6.6-y320-Win32")
{
	byte bosshp       : "fceux.exe", 0x5372A0, 0x6C1;
	byte myhp         : "fceux.exe", 0x5372A0, 0x6C0;
	byte mylives      : "fceux.exe", 0x5372A0, 0xA8;
	byte mytitlescreen: "fceux.exe", 0x5372A0, 0x04B0;
	byte mycontroller : "fceux.exe", 0x5372A0, 0x25;
	byte soundfx      : "fceux.exe", 0x5372A0, 0xE2;
	byte stage        : "fceux.exe", 0x5372A0, 0x2A;
}

startup
{
	settings.Add("optionsection", true, "---Options---");
	settings.Add("onteleport", true, "Split after teleport instead of boss kill", "optionsection");

	settings.Add("infosection", true, "---Info---");
	settings.Add("info", true, "Mega Man 2 Autosplitter by ye", "infosection");
