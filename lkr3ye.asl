...
{
	byte enemyhp       : "fceux.exe", 0x5372A0, 0x4FF;
	byte secondenemyhp : "fceux.exe", 0x5372A0, 0x4FE;
	byte enemyid       : "fceux.exe", 0x5372A0, 0x4DF;
	byte secondenemyid : "fceux.exe", 0x5372A0, 0x4DE;
	byte myhp          : "fceux.exe", 0x5372A0, 0xA2;
