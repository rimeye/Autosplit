...
{
	byte enemyhp    : "fceux.exe", 0x3C920C, 0x467;
	byte enemyid    : "fceux.exe", 0x3C920C, 0x44F;
	...
	byte selection  : "fceux.exe", 0x3C920C, 0x200;
...
{
	byte enemyhp    : "fceux.exe", 0x5372A0, 0x467;
	byte enemyid    : "fceux.exe", 0x5372A0, 0x44F;
	byte myhp       : "fceux.exe", 0x5372A0, 0xB0;
	byte soundfx    : "fceux.exe", 0x5372A0, 0x702;
	byte stage      : "fceux.exe", 0x5372A0, 0x22;
	byte screen     : "fceux.exe", 0x5372A0, 0xCB;
	byte selection  : "fceux.exe", 0x5372A0, 0x200;
	byte levelscreen: "fceux.exe", 0x5372A0, 0xF9;
}
