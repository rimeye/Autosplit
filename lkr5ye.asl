...
{
	byte enemyhp : "fceux.exe", 0x5372A0, 0x458;
	byte enemyid : "fceux.exe", 0x5372A0, 0x440;
	byte myhp : "fceux.exe", 0x5372A0, 0xB0;
	byte soundfx : "fceux.exe", 0x5372A0, 0x702;
	byte stage : "fceux.exe", 0x5372A0, 0x26;
	byte screenassets : "fceux.exe", 0x5372A0, 0x611;
	byte otherscreenassets : "fceux.exe", 0x5372A0, 0x18B;
	byte levelscreen : "fceux.exe", 0x5372A0, 0xF9;
	byte controller : "fceux.exe", 0x5372A0, 0x16;
	byte fade : "fceux.exe", 0x5372A0, 0x612;
}
